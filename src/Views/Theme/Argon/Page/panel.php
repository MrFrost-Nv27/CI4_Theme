                                        ...
                                        <div class="widget-content-left me-3">
                                            <div class="widget-content-left">
                                                <img width="40" class="rounded-circle"
                                                    src="<?= base_url('assets/architect') ?>/images/avatars/4.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left me-3">
                                            <div class="widget-content-left">
                                                <img width="40" class="rounded-circle"
                                                    src="<?= base_url('assets/architect') ?>/images/avatars/3.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="widget-content-left flex2">
                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left me-3">
                                            <div class="widget-content-left">
                                                <img width="40" class="rounded-circle"
                                                    src="<?= base_url('assets/architect') ?>/images/avatars/2.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="widget-content-left flex2">
                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left me-3">
                                            <div class="widget-content-left">
                                                <img width="40" class="rounded-circle"
                                                    src="<?= base_url('assets/architect') ?>/images/avatars/1.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="widget-content-left flex2">
