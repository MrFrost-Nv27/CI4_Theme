    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6 col-4 align-self-center">
            <div class="text-end upgrade-btn">
                <a href="#!" class="btn btn-danger d-none d-md-inline-block text-white">Add New</a>
            </div>
        </div>
    </div>
</div>
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-4 col-xlg-3">
            <div class="card">
                <img class="card-img-top" src="<?= base_url('assets/materialpro') ?>/images/background/profile-bg.jpg"
                    alt="Card image cap">
                <div class="card-body little-profile text-center">
                    <div class="pro-img"><img src="<?= base_url('assets/materialpro') ?>/images/users/4.jpg" alt="user">
                    </div>
                    ...
                    <div class="message-box contact-box">
                        ...
                        <div class="message-widget contact-widget">
                            <a href="#" class="d-flex align-items-center">
                                <div class="user-img mb-0"> <img
                                        src="<?= base_url('assets/materialpro') ?>/images/users/1.jpg" alt="user"
                            ...
                            <a href="#" class="d-flex align-items-center">
                                <div class="user-img mb-0"> <img
                                        src="<?= base_url('assets/materialpro') ?>/images/users/2.jpg" alt="user"
                            ...
                            <a href="#" class="d-flex align-items-center">
                                <div class="user-img mb-0"> <img
                                        src="<?= base_url('assets/materialpro') ?>/images/users/4.jpg" alt="user"
                    ...
                    <div class="tab-pane active" id="home" role="tabpanel">
                        <div class="card-body">
                            <div class="profiletimeline border-start-0">
                                        ...
                                        <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-6 mb-3"><img
                                                        src="<?= base_url('assets/materialpro') ?>/images/big/img1.jpg"
                                                        alt="user" class="img-responsive radius w-100">
                                                </div>
                                                <div class="col-lg-3 col-md-6 mb-3"><img
                                                        src="<?= base_url('assets/materialpro') ?>/images/big/img2.jpg"
                                                        alt="user" class="img-responsive radius w-100">
                                                </div>
                                                <div class="col-lg-3 col-md-6 mb-3"><img
                                                        src="<?= base_url('assets/materialpro') ?>/images/big/img3.jpg"
                                                        alt="user" class="img-responsive radius w-100">
                                                </div>
                                                <div class="col-lg-3 col-md-6 mb-3"><img
                                                        src="<?= base_url('assets/materialpro') ?>/images/big/img4.jpg"
                                                        alt="user" class="img-responsive radius w-100">
                                                </div>
                                            </div>
                                            <div class="like-comm"> <a href="javascript:void(0)" class="link me-2">2
                                        ...
                                        <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5
                                            ...
                                            <div class="mt-3 row">
                                                <div class="col-md-3 col-xs-12"><img
                                                        src="<?= base_url('assets/materialpro') ?>/images/big/img1.jpg"
                                                        alt="user" class="img-responsive w-100 radius">
                                                </div>
                                            ...
                                            <div class="like-comm mt-3"> <a href="javascript:void(0)"
                                                    ...
                                                    class="link me-2"><i class="fa fa-heart text-danger"></i> 5 Love</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sl-item">
                                    <div class="sl-left"> <img
                                            src="<?= base_url('assets/materialpro') ?>/images/users/3.jpg" alt="user"
                                            class="img-circle"> </div>
                                    <div class="sl-right">
                                        <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                                                minutes ago</span>
                                        ...
                                        <div class="like-comm mt-3"> <a href="javascript:void(0)" class="link me-2">2
                                                comment</a> <a href="javascript:void(0)" class="link me-2"><i
